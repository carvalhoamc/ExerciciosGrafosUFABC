// Introdução à Programação Orientada a Objetos Usando Java, p303
...
/**
 * A classe UsaKeyboard ilustra usos dos métodos estáticos na classe
 * Keyboard para leitura (a partir do teclado ou de arquivos de resposta) de
 * valores de tipos nativos e de instâncias da classe String.
 */
public class UsaKeyboard
  {
  /**
   * O método main permite a execução desta classe. Este método ilustra
   * usos dos métodos estáticos na classe Keyboard.
   ...
   */
   public static void main(String[] argumentos)
    ...
    // Lê um booleano e o usa para mostrar (ou não) as mensagens.
    Keyboard.setDebug(Keyboard.readBoolean(false));
    // Leitura de valores booleanos.
    // true, t, yes, y, on, v, s, sim, verdadeiro são sinônimos de true.
    // false, f, no, n, off, nao, não, falso são sinônimos de false.
    boolean b1, b2;
    ...
    char c1, c2;
    System.out.print("Entre um caractere ou Enter para [espaço]: ");
    ...
    by2 = Keyboard.readByte((byte)-123);  // Cast é necessário!
    ...
    s2 = Keyboard.readShort((short)-9999);  // Cast é necessário!
    ...
    l2 = Keyboard.readLong(-1000);  // Argumento int será convertido para long.
