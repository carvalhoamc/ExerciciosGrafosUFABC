...
.leDoTeclado(): faz a leitura de um grafo pela entrada padrão via teclado.
                (Sobrecarrega método original para leitura de grafos 
                ponderados).
.imprimeNaTela(): imprime listas de adjacencia e matriz de adjacencia.
                (Sobrecarrega método original para impressao de grafos 
                ponderados).
...
// Esta classe é derivada da classe Grafo, ou seja, herda os atributos
// e métodos da classe ancestral.
